  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-2xl">Book a Tour</DialogTitle>
        ...
        {!isConfirmed ? (
          ...
          <div className="py-12 text-center animate-scale-in">
            ...
            <h3 className="text-2xl font-bold mb-2">Tour Booked!</h3>
            <p className="text-muted-foreground">
              Your tour is scheduled for {date?.toLocaleDateString()} at {selectedTime}
            </p>
          </div>
        )}
      </DialogContent>
